    ...
    context '出品ができない時' do
      ...
      it ' delivery_charge_idがない場合は出品できないこと' do
        ...
        expect(@item.errors.full_messages).to include("Delivery charge can't be blank", "Delivery charge can't be blank",
                                                      'Delivery charge is not a number')
      end
      ...
      it ' day_to_ship_idがない場合は出品できないこと' do
        @item.day_to_ship_id = ''
        @item.valid?
        expect(@item.errors.full_messages).to include("Day to ship can't be blank", "Day to ship can't be blank",
                                                      'Day to ship is not a number')
      end
